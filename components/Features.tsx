      ...
      <div className='flex max-container padding-container relative w-full justify-end'>
        ...
        <div className='z-20 flex w-full flex-col lg:w-[60%]'>
          <div className='relative'>
            ...
            <h2 className='bold-40 lg:bold-64'>Наши особенности</h2>
          </div>
          <ul className='mt-10 grid gap-10 md:grid-cols-2 lg:md-20 lg:gap-20'>
            {FEATURES.map((feature) => (<FeatureItem key={feature.title} title={feature.title} icon={feature.icon} variant={feature.variant} description={feature.description} />))}
          </ul>
        </div>
